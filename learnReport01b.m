...
AllP = {};  
AllP{1} = allP;       AllP{1}.attr0  = attr0;  % attr0s;
AllP{2} = allP;       AllP{2}.attr0  = attr0o; 

d0{1} = dHubClassLrn(AllP{1});                           % from dHubClassSerDict
d0{2} = dHubClassLrn(AllP{2});                           % from dHubClassSerDict
